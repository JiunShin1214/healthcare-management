...
MEDICAL_RAG_ENABLED = _env_bool("MEDICAL_RAG_ENABLED", True)
MEDICAL_RAG_CHROMA_PATH = os.getenv("MEDICAL_RAG_CHROMA_PATH", "")
MEDICAL_RAG_COLLECTION_NAME = os.getenv("MEDICAL_RAG_COLLECTION_NAME", "medical_docs")
MEDICAL_RAG_EMBEDDING_MODEL = os.getenv("MEDICAL_RAG_EMBEDDING_MODEL", "text-embedding-3-small")
MEDICAL_RAG_CHAT_MODEL = os.getenv("MEDICAL_RAG_CHAT_MODEL", "gpt-4o-mini")
MEDICAL_RAG_OPENAI_API_KEY = os.getenv("OPENAI_API_KEY", "")
